...
public class ItemSoulVessel extends Item implements IAddition {
    public ItemSoulVessel() {
    ...
    public void registerRecipe(IForgeRegistry<IRecipe> registry) {
        BloodMagicAPI.INSTANCE.getRecipeRegistrar().addAlchemyTable(new ItemStack(this, 3), 200, 100, AltarTier.THREE.toInt(),
                Items.GLASS_BOTTLE, Items.GLASS_BOTTLE, Items.GLASS_BOTTLE, Items.CLAY_BALL, Blocks.SOUL_SAND);
    }
